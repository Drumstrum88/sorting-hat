...
const students = [
  ...
  imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6LBMwAr3TF3lpCkBqcks6mee0e0pb7PGC5A&usqp=CAU" 
    ...
    {
  houseName: 'slytherin',
  imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-HPVeMZOd7gwPJZoFGE4p3xtp43J81XGmlQ&usqp=CAU"
    }
  ]
  ...
  const cardsOnDom = (array) => {
    ...
    for (const student of array) {
      ...
      <div class="card-body">
        ...
        <img src"${hogwartsHouses.imageUrl}">
  ...
  const slyBtn = document.querySelector('#slytherin');
   ...
   const deathEatersOnDom = (array) => {
    ...
    for (const deathEater of array) {
      domString += `<container id="deat-eaters></container> <div class="card" style="width: 18rem;">
