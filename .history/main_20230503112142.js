...
const students = [
  ...
  const addStudent = (e) => {
    ...
    const newStudent = {
      ...
      imageUrl: student.crest,
      
    };
    
    for (const student of hogwartshouses)
       if(newStudent.house === "gryffindor") { crestImg = "https://i.pinimg.com/474x/c5/29/c9/c529c9dbe59782640aa7d0006c90ebeb.jpg";
         ...
         newStudent.crest = "https://i.pinimg.com/474x/4e/93/9e/4e939e601d8847248e06a7f4f416214b.jpg";
       } else if(newStudent.house === "ravenclaw") {
          newStudent.crest = "https://i.pinimg.com/474x/0c/db/24/0cdb246ed2f5cd6684c2105e40e6b42a.jpg"
       } else { newStudent.crest = "https://i.pinimg.com/474x/7e/73/8b/7e738b77dc63f51579a4318caa7cd358.jpg";}
