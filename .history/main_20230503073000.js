...
const students = [
  ...
  const addStudent = (e) => {
    ...
    for (const house of hogwartsHouses) {
       ...
       if(hogwartsHouses.randoHouse === "gryffindor") { crestImg = "https://i.pinimg.com/474x/c5/29/c9/c529c9dbe59782640aa7d0006c90ebeb.jpg";
       } else if(hogwartsHouses.randoHouse === "hufflepuff") {
         crestImg = "https://i.pinimg.com/474x/4e/93/9e/4e939e601d8847248e06a7f4f416214b.jpg";
       } else if(hogwartsHouses.randoHouse === "ravenclaw") {
